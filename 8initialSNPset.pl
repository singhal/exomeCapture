...
sub callVariants {
    ...
    my $call2 = system("samtools mpileup -B -uf $target $reads | bcftools view -bvcg - > var.raw.bcf");
    my $call3 = system("bcftools view -I var.raw.bcf > $outVCF");
    my $call4 = system("rm var.raw.bcf");
}
